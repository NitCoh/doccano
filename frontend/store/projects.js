...
export const getters = {
    ...
    getFilterOption(state) {
        ...
        } else if(state.current.project_type === "VQARelevantClassification"){
            return 'doc_annotations__isnull'
        }else {
            return ''
        }
    ...
    getLink(state) {
        if (state.current.project_type === 'DocumentClassification') {
            ...
            return 'vqa-relevant-classification'
        } else {
            return ''
        }
    },
    getImportFormat(state) {
        ...
        if (state.current.project_type === 'DocumentClassification') {
            ...
            json.examples = [
                '{"text": "Is the tall clock small or large?", "meta": {"question_id": "15736264", "answer": "large", "img_id": "2368326"}}\n',
                '{"text": "What kind of furniture is to the right of the chair?", "meta": {"question_id": "19274091", "answer": "sofa", "img_id": "2410353"}}\n',
                '{"text": "Is the steel spatula in the top of the image?", "meta": {"question_id": "00974084", "answer": "no", "img_id": "2322142"}}'
